...
EPOCHS = 150     # Уменьшаем эпохи для демо (можно увеличить до 100 при наличии данных)
LEARNING_RATE = 0.001
...
# ==================== ОБУЧЕНИЕ МОДЕЛИ ====================
def train_anomaly_model(data_dir, output_dir="anomaly_models/interior"):
    """Обучение модели аномалий для дверей с генеративной аугментацией"""
...
if __name__ == "__main__":
    ...
    data_dir = "data/interior/good_samples"
